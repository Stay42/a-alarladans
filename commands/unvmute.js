...
message.channel.send(reawEmbed.setDescription(`${client.emojis.cache.get(a.yes)} ${member} kullanıcısının vmute cezası ${message.author} tarafından kaldırıldı!`));
message.guild.channels.cache.get(a.muteLog).send(reawEmbed.setDescription(`${client.emojis.cache.get(a.yes)} ${member} kullanıcısının vmute cezası ${message.author} tarafından kaldırıldı!`));
